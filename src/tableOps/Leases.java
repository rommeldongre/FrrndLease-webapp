...
public class Leases extends Connect {
	...
	private void getNextActive () {
		...
		String sql = "SELECT  tb1.*, tb2.user_full_name FROM leases tb1 INNER JOIN users tb2 ON tb1.lease_requser_id = tb2.user_id WHERE lease_id > ? AND lease_status= ? ORDER BY lease_id LIMIT 1";		//

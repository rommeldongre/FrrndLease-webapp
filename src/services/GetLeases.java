...
/**
 * Servlet implementation class GetLeases
 */
@WebServlet("/GetLeases")
public class GetLeases extends HttpServlet {

	private FlsLogger LOGGER = new FlsLogger(GetLeases.class.getName());

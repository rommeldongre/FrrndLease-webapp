...
/**
 * Servlet implementation class DeletePosting
 */
@WebServlet("/DeletePosting")
public class DeletePosting extends HttpServlet {

	private FlsLogger LOGGER = new FlsLogger(DeletePosting.class.getName());

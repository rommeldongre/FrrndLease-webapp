...
/**
 * Servlet implementation class BrowseItem
 */
@WebServlet("/GetItemStore")
public class GetItemStore extends HttpServlet {

	private FlsLogger LOGGER = new FlsLogger(GetItemStore.class.getName());

...
/**
 * Servlet implementation class ReinviteFriend
 */
@WebServlet("/ReinviteFriend")
public class ReinviteFriend extends HttpServlet {

	private FlsLogger LOGGER = new FlsLogger(ReinviteFriend.class.getName());
